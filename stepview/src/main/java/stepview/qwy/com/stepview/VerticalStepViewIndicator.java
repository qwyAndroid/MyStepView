    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        for(int i = 0; i < mCircleCenterPointPositionList.size() - 1; i++)
        {
            ...
            if(i < mComplectingPosition)//判断在完成之前的所有点
            {
                ...
                if(mIsReverseDraw)
                {
                    canvas.drawRect(mLeftY, afterComplectedXPosition + mCircleRadius - 10,
                            mRightY, preComplectedXPosition - mCircleRadius + 10, mCompletedPaint);
                } else
                {
                    canvas.drawRect(mLeftY, preComplectedXPosition + mCircleRadius - 10,
                            mRightY, afterComplectedXPosition - mCircleRadius + 10, mCompletedPaint);
                }
            } else
            {
                if(mIsReverseDraw)
        ...
        for(int i = 0; i < mCircleCenterPointPositionList.size(); i++)
        {
            ...
            mRect = new Rect((int) (mCenterX - mCircleRadius), (int) (currentComplectedXPosition - mCircleRadius),
                    (int) (mCenterX + mCircleRadius), (int) (currentComplectedXPosition + mCircleRadius));
